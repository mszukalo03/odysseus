...
async def _execute_tool_block_impl(
    ...
    from src.tool_implementations import (
        ...
        do_manage_calendar,
        do_get_ithaca_weather, do_get_ithaca_software_updates,
    ...
    elif tool == "get_ithaca_weather":
        desc = "get_ithaca_weather"
        result = await do_get_ithaca_weather(content, owner=owner)
    elif tool == "get_ithaca_software_updates":
        desc = "get_ithaca_software_updates"
        result = await do_get_ithaca_software_updates(content, owner=owner)
