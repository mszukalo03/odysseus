...
import { parseCSV, csvEscapeField, syncTableToTextarea } from './documentCsv.js';
import { _computeLineDiff, _buildDiffChunks, simpleDiff, lineDiff } from './documentDiffAlgo.js';
import { DOC_PANE_TEMPLATE } from './documentPaneTemplate.js';
import {
  _selections, clearSelection, syncSelectionOverlay, updateSelectionState,
  _scheduleSelRerender, getSelectionContext,
} from './documentSelection.js';
import {
  applyMdFormat, _replaceRange, _currentBlockTag, initMdToolbar, initMdToolbarDeps,
} from './documentMdToolbar.js';
import {
  renderFindRects, applyFindMarks, syncHighlighting, updateLineNumbers,
  syncGutterScroll, _looksLikeMarkdown,
  ...
  export function init(apiBase) {
    ...
    initMdToolbarDeps({ getEmailRichbodyActive: _emailRichbodyActive });
