...
function mount(container) {
  ...
  root.innerHTML = `
    <div class="rss-pane-header" data-ws-popup-header>
      ...
      <button data-ws-split class="doc-action-icon-btn" title="Split screen with another feature" style="opacity:0.8;">
      ...
      <button id="rss-close-btn" class="doc-action-icon-btn" data-action="close" title="Close RSS" style="opacity:0.8;">
